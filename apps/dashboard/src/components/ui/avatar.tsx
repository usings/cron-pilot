...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      ...
      className={cn(
        'size-8 after:border-border group/avatar relative flex shrink-0 select-none after:absolute after:inset-0 after:border after:mix-blend-darken dark:after:mix-blend-lighten',
        'data-[size=lg]:size-10 data-[size=sm]:size-6',
        'data-[rounded=true]:rounded-full data-[rounded=true]:after:rounded-full',
        className,
      )}
      {...props}
    />
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        ...
        'group-data-[rounded=true]/avatar:rounded-full',
        className,
      )}
      {...props}
    />
