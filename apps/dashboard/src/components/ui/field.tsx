  ...
  return (
    <Label
      ...
      className={cn(
        ...
        "data-[required=true]:after:content-['*'] data-[required=true]:after:text-destructive data-[required=true]:after:align-top",
        className,
      )}
      {...props}
    />
...
function FieldError({
  ...
  const content = useMemo(() => {
    ...
    const uniqueErrors = [
      ...new Map(
        errors.filter((e): e is { message: string } => Boolean(e?.message)).map((e) => [e.message, e]),
      ).values(),
    ]
